...
- **Auditoría:** cada encargo tiene su PR (#6 a #12) con checklist marcado, muestreo recalculado a mano y comentarios en líneas concretas. La comparación con Gemini Code Assist está en `resultados/comparacion_gemini.md`.
